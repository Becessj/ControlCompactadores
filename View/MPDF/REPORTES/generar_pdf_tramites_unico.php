        ...
        <body >
          ...
          <htmlpageheader name="myHeader1" style="display:none;">
            <table width="100%" border="0">
                <tr>
                  <th style="width:50px">
                    <img src="../../usuario/'.$logo.'" style="width:80px">
                  </th>
          ...
          <table border="0" id="table2" style="table-layout:fixed;width: 100%;font-size:10px;">
           ...
           //while($row1 = $resultado1->fetch_assoc()){
            ...
            $contador++;
                ...
                YEAR(documento.doc_fecharegistro) anio
                FROM
                documento
          ...
          <table style="text-align:center" align="center">
            <tr>
              <td>
                <barcode code="http'.(empty($_SERVER['HTTPS'])?'':'s').'://'.$_SERVER['SERVER_NAME'].'/Sistema_MesaPartes/seguimiento_qr.php?nro_seguimiento='.$nro_seguimiento.'&dni='.$dni.'&anio='.$anio.'" type="QR" class="barcode" size="1.5" error="M" disableborder="1"/>
              </td>
            </tr>
          </table>
        </body>
